                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <a href="<?php echo e(url('/admin/upload-item')); ?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Add Item</a>
                        </ol>
                    </div>
                </div>
            </div>
...
<?php /**PATH D:\xampp\htdocs\feberr2\resources\views/admin/items.blade.php ENDPATH**/ ?>