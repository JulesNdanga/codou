        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1 class="page-title"><?php echo e(Helper::translation(2931,$translate)); ?> <span class="lnr lnr-arrow-right"></span> <?php echo e($type_name->item_type_name); ?></h1>
                </div>
                <!-- end /.col-md-12 -->
            </div>
            <!-- end /.row -->
                            ...
                            <div class="upload_modules module--upload">
                                ...
                                <div class="modules__content">
                                    ...
                                    <div class="form-group" id="youtube">
                                        <label for="tags"><?php echo e(Helper::translation(2967,$translate)); ?> <sup>*</sup></label>
...
<?php endif; ?><?php /**PATH C:\wamp64\www\aa5\codester-14224-feberr-multivendor-digital-products-marketplace\Files-DaAZynnEY31NPwV11N\feberr\resources\views/upload-item.blade.php ENDPATH**/ ?>