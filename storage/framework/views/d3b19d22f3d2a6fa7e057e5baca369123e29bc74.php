                ...
                <div class="col-md-12">
                    <div class="breadcrumb">
                        <ul>
                            ...
                            <li>
                                <a href="<?php echo e(URL::to('/withdrawal')); ?>"><?php echo e(Helper::translation(3211,$translate)); ?></a>
                            </li>
                            
                        </ul>
                    </div>
                    <h1 class="page-title"><?php echo e(Helper::translation(3211,$translate)); ?></h1>
                </div>
                <!-- end /.col-md-12 -->
            </div>
            <!-- end /.row -->
...
<?php endif; ?><?php /**PATH C:\wamp64\www\aa5\codester-14224-feberr-multivendor-digital-products-marketplace\Files-DaAZynnEY31NPwV11N\feberr\resources\views/withdrawal.blade.php ENDPATH**/ ?>