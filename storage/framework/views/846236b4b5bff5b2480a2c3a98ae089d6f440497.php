                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">Font Awesome Icon 1 <small>( example : <strong>fa fa-magic</strong> )</small></label>
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">Text 1</label>
                             ...
                             <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">Font Awesome Icon 2 <small>( example : <strong>fa fa-money</strong> )</small></label>
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">Text 2</label>
                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">Font Awesome Icon 3 <small>( example : <strong>fa fa-code</strong> )</small></label>
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">Text 3</label>
                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">Font Awesome Icon 4 <small>( example : <strong>fa fa-lock</strong> )</small></label>
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">Text 4</label>
...
<?php /**PATH D:\xampp\htdocs\feberr\resources\views/admin/highlights.blade.php ENDPATH**/ ?>