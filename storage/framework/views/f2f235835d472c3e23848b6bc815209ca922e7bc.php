        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1 class="page-title"><?php echo e(Helper::translation(3097,$translate)); ?></h1>
                </div>
                <!-- end /.col-md-12 -->
            </div>
            <!-- end /.row -->
...
<?php endif; ?><?php /**PATH D:\xampp\htdocs\feberr\resources\views/order-details.blade.php ENDPATH**/ ?>