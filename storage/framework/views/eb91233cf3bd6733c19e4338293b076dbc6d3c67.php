<script src="<?php echo e(asset('public/assets/js/vendor/jquery/jquery-1.12.3.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/vendor/jquery/popper.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/vendor/jquery/uikit.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/vendor/bootstrap.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/vendor/chart.bundle.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/vendor/grid.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/vendor/jquery-ui.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/vendor/jquery.barrating.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/vendor/jquery.countdown.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/vendor/jquery.counterup.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/vendor/jquery.easing1.3.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/vendor/owl.carousel.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/vendor/slick.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/vendor/tether.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/vendor/trumbowyg.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/vendor/waypoints.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('public/assets/js/map.js')); ?>"></script>
...
<script src="<?php echo e(asset('public/assets/pagination/pagination.js')); ?>"></script>
<script type="text/javascript">
    $(document).ready(function() {
      $(this).cPager({
...
<script src="<?php echo e(asset('public/share/share.js')); ?>"></script> 
<script type="text/javascript">
...
<script src="<?php echo e(asset('public/filter/jplist.core.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/filter/jplist.sort-bundle.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/filter/jplist.textbox-filter.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/filter/jplist.filter-toggle-bundle.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/filter/jplist.pagination-bundle.min.js')); ?>"></script>
...
<?php endif; ?>
<script src="<?php echo e(asset('public/lightbox/topbox.js')); ?>"></script>
...
<script src="<?php echo e(asset('public/video/video.popup.js')); ?>"></script>
...
<script type="text/javascript" src="<?php echo e(URL::to('public/countdown/jquery.countdown.js?v=1.0.0.0')); ?>"></script>

<script src="<?php echo e(URL::to('resources/views/assets/custom.js')); ?>"></script><?php /**PATH C:\wamp64\www\aa5\codester-14224-feberr-multivendor-digital-products-marketplace\Files-DaAZynnEY31NPwV11N\feberr\resources\views/javascript.blade.php ENDPATH**/ ?>