                ...
                <div class="col-md-12">
                    <div class="breadcrumb">
                        <ul>
                            ...
                            <li class="active">
                                <a href="<?php echo e(URL::to('/cart')); ?>"><?php echo e(Helper::translation(2885,$translate)); ?></a>
                            </li>
                        </ul>
                    </div>
                    <h1 class="page-title"><?php echo e(Helper::translation(2885,$translate)); ?></h1>
                </div>
                <!-- end /.col-md-12 -->
            </div>
            <!-- end /.row -->
                                ...
                                <div class="single_product clearfix">
                                    ...
                                    <div class="col-lg-3 col-md-2 v_middle">
                                        <div class="product__additional_info">
                                            <ul>
                                                <li>
                                                    <?php echo e($cart->license); ?><?php if($cart->license == 'regular'): ?> (<?php echo e(Helper::translation(2890,$translate)); ?>) <?php elseif($cart->license == 'extended'): ?> (<?php echo e(Helper::translation(2891,$translate)); ?>) <?php endif; ?>
                                                </li>
                                            </ul>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 offset-md-6">
                                ...
                                <div class="cart--subtotal">
                                   ...
                                   <input type="text" class="form-control coupon-text" id="coupon" name="coupon" value="" required><button type="submit" class="btn btn--sm theme-button"><?php echo e(Helper::translation(2893,$translate)); ?></button></p>
                                    </div>
                                    <div class="cart--subtotal">
                                        <p>
                                    ...
                                    <a href="<?php echo e(url('/checkout')); ?>" class="btn btn--md checkout_link theme-button"><?php echo e(Helper::translation(2897,$translate)); ?></a>
                                </div>
                            </div>
                            <!-- end .col-md-12 -->
                        </div>
...
<?php endif; ?><?php /**PATH C:\wamp64\www\aa5\codester-14224-feberr-multivendor-digital-products-marketplace\Files-DaAZynnEY31NPwV11N\feberr\resources\views/cart.blade.php ENDPATH**/ ?>