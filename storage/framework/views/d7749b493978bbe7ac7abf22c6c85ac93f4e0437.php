...
.theme-primary
{
background:<?php echo e($allsettings->site_primary_color); ?> !important;
}
.theme-button
{
...
#product-details ul li:before {
  content: url("<?php echo e(asset('public/assets/images/check.png')); ?>");
  margin-right: 15px;
}
.promotion-area {
  padding: 140px 0;
  background: url("<?php echo e(asset('public/assets/images/bundlebg.jpg')); ?>");
...
background:<?php echo e($allsettings->site_primary_color); ?>;
color:#FFFFFF;
text-align:center;
min-width:70px;
opacity:0.6;
...
.search-area2:before, .breadcrumb-area:before {
  ...
  width: 100%;
  position: absolute;
  background: url("<?php echo e(asset('public/storage/settings/')); ?>/<?php echo e($allsettings->site_banner); ?>") !important;
  opacity: 1;
  top: 0;
  left: 0;
}
...
.range-price
{
border:0; color:<?php echo e($allsettings->site_button_color); ?> !important; font-weight:bold;
font-size:16px;
margin-bottom:14px;
}
...
.custom-radio label span.circle:before, .custom-radio .form-group p.label span.circle:before, .form-group .custom-radio p.label span.circle:before {
  content: "";
  background: #fff;
  border: 4px solid <?php echo e($allsettings->site_button_color); ?>;
}
...
{
background:<?php echo e($allsettings->site_primary_color); ?> !important;
border:1px solid <?php echo e($allsettings->site_primary_color); ?> !important;
}
*/
...
.dropdowns.dropdown--cart .cart_area .cart_action .go_cart {
  background: <?php echo e($allsettings->site_secondary_color); ?> !important;
}
...
<?php endif; ?><?php /**PATH C:\wamp64\www\aa5\codester-14224-feberr-multivendor-digital-products-marketplace\Files-DaAZynnEY31NPwV11N\feberr\resources\views/dynamic-style.blade.php ENDPATH**/ ?>