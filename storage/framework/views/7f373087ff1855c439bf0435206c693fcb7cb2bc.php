                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php endif; ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="file" id="item_screenshot" name="item_screenshot[]" class="files"><small>(Size : 750x430px)</small><br/><br/><?php $__currentLoopData = $item_image['item']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
