                ...
                <div class="col-md-12">
                    <div class="breadcrumb">
                        <ul>
                            ...
                            <li class="active">
                                <a href="<?php echo e(URL::to('/page')); ?>/<?php echo e($page['page']->page_id); ?>/<?php echo e($page['page']->page_slug); ?>"><?php echo e($page['page']->page_title); ?></a>
                            </li>
                        </ul>
                    </div>
                    <h1 class="page-title"><?php echo e($page['page']->page_title); ?></h1>
                </div>
                <!-- end /.col-md-12 -->
            </div>
            <!-- end /.row -->
...
<?php endif; ?><?php /**PATH C:\wamp64\www\aa5\codester-14224-feberr-multivendor-digital-products-marketplace\Files-DaAZynnEY31NPwV11N\feberr\resources\views/page.blade.php ENDPATH**/ ?>