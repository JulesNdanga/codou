...
<head>
    <title><?php echo e(Helper::translation(3188,$translate)); ?> - <?php echo e($allsettings->site_title); ?></title>
                ...
                <div class="col-md-12">
                    <div class="breadcrumb">
                        <ul>
                            ...
                            <li class="active">
                                <a href="#"><?php echo e(Helper::translation(3188,$translate)); ?></a>
                            </li>
                        </ul>
                    </div>
                    <h1 class="page-title"><?php echo e(Helper::translation(3188,$translate)); ?></h1>
                </div>
                <!-- end /.col-md-12 -->
            </div>
            <!-- end /.row -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="product_archive added_to__cart padding-top-70">
                        ...
                        <div align="center"><h4><?php echo e(Helper::translation(3189,$translate)); ?></h4><br/>
...
<?php endif; ?><?php /**PATH C:\wamp64\www\aa5\codester-14224-feberr-multivendor-digital-products-marketplace\Files-DaAZynnEY31NPwV11N\feberr\resources\views/success.blade.php ENDPATH**/ ?>