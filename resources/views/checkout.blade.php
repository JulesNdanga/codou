                ...
                <div class="col-md-12">
                    <div class="breadcrumb">
                        <ul>
                            ...
                            <li class="active">
                                <a href="{{ URL::to('/checkout') }}">{{ Helper::translation(2899,$translate) }}</a>
                            </li>
                        </ul>
                    </div>
                    <h1 class="page-title">{{ Helper::translation(2899,$translate) }}</h1>
                </div>
                <!-- end /.col-md-12 -->
            </div>
            <!-- end /.row -->
                        ...
                        <div class="information_module payment_options">
                                ...
                                <div class="payment_info modules__content">
                                    ...
                                    <div class="row">
                                       @if($cart_count != 0)
                                        <div class="col-md-6">
                                             <button type="submit" class="btn btn--default theme-button">{{ Helper::translation(2904,$translate) }}</button>
                                        </div>
                                       @else
                                       <div class="col-md-6">
                                             <a href="javascript:void(0);" class="btn btn--default theme-button" onClick="alert('{{ Helper::translation(2898,$translate) }}');">{{ Helper::translation(2904,$translate) }}</a>
                                       </div>
                                       @endif  
