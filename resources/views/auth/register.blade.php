                ...
                <div class="col-md-12">
                    <div class="breadcrumb">
                        <ul>
                            ...
                            <li class="active">
                                <a href="{{ URL::to('/register') }}">{{ Helper::translation(3233,$translate) }}</a>
                            </li>
                        </ul>
                    </div>
                    <h1 class="page-title">{{ Helper::translation(3233,$translate) }}</h1>
                </div>
                    ...
                    @csrf
                        <div class="cardify signup_form">
                            ...
                            <div class="login--form">
                                ...
                                <button class="btn btn--md register_btn theme-button" type="submit">{{ Helper::translation(3233,$translate) }}</button>
