                ...
                <div class="col-md-12">
                    <div class="breadcrumb">
                        <ul>
                            ...
                            <li>
                                <a href="{{ URL::to('/profile-settings') }}">{{ Helper::translation(3109,$translate) }}</a>
                            </li>
                            
                        </ul>
                    </div>
                    <h1 class="page-title">{{ Helper::translation(3109,$translate) }}</h1>
                </div>
                <!-- end /.col-md-12 -->
            </div>
            <!-- end /.row -->
               ...
               <form action="{{ route('profile-settings') }}" class="setting_form" method="post" id="item_form" enctype="multipart/form-data">
                {{ csrf_field() }}   
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div align="left">
                                <button type="submit" class="btn btn--md theme-button">{{ Helper::translation(3138,$translate) }}</button>
                            </div>
                        </div>
                        <!-- end /.col-md-12 -->
                    </div>
