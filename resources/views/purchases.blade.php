                ...
                <div class="col-md-12">
                    <div class="breadcrumb">
                        <ul>
                            ...
                            <li>
                                <a href="{{ URL::to('/purchases') }}">{{ Helper::translation(3024,$translate) }}</a>
                            </li>
                            
                        </ul>
                    </div>
                    <h1 class="page-title">{{ Helper::translation(3024,$translate) }}</h1>
                </div>
                <!-- end /.col-md-12 -->
            </div>
            <!-- end /.row -->
                                    ...
                                    <div class="col-lg-4 col-md-4 col-6 xs-fullwidth">
                                        <div class="product__price_download">
                                            ...
                                            @if($item->approval_status == 'payment released to vendor')
                                                <a href="{{ url('/purchases') }}/{{ $item->item_token }}" class="btn btn--md theme-button">{{ Helper::translation(3144,$translate) }}</a>
