                ...
                <div class="col-md-12">
                    <div class="breadcrumb">
                        <ul>
                            ...
                            <li class="active">
                                <a href="{{ URL::to('/cart') }}">{{ Helper::translation(2885,$translate) }}</a>
                            </li>
                        </ul>
                    </div>
                    <h1 class="page-title">{{ Helper::translation(2885,$translate) }}</h1>
                </div>
                <!-- end /.col-md-12 -->
            </div>
            <!-- end /.row -->
                                ...
                                <div class="single_product clearfix">
                                    ...
                                    <div class="col-lg-3 col-md-2 v_middle">
                                        <div class="product__additional_info">
                                            <ul>
                                                <li>
                                                    {{ $cart->license }}@if($cart->license == 'regular') ({{ Helper::translation(2890,$translate) }}) @elseif($cart->license == 'extended') ({{ Helper::translation(2891,$translate) }}) @endif
                                                </li>
                                            </ul>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 offset-md-6">
                                ...
                                <div class="cart--subtotal">
                                   ...
                                   <input type="text" class="form-control coupon-text" id="coupon" name="coupon" value="" required><button type="submit" class="btn btn--sm theme-button">{{ Helper::translation(2893,$translate) }}</button></p>
                                    </div>
                                    <div class="cart--subtotal">
                                        <p>
                                    ...
                                    <a href="{{ url('/checkout') }}" class="btn btn--md checkout_link theme-button">{{ Helper::translation(2897,$translate) }}</a>
                                </div>
                            </div>
                            <!-- end .col-md-12 -->
                        </div>
